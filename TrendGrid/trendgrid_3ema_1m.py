    ...
    def OnData(self, data):
        ...
        for symbol, symData in self.Data.items():
            ...
            if self.Portfolio[symbol].IsLong:
                ...
                if totalPL >= symData.profitTarget or emaFast < emaVSlow:
            ...
            if not self.Portfolio[symbol].Invested:
                ...
                min = symData.min.Current.Value
                max = symData.max.Current.Value
                ...
                if emaSlow > emaVSlow and emaFast > emaSlow and price < emaFast and price > emaVSlow and min > emaVSlow and emaFast > (emaVSlow + entryDist):
                    symbolGridParams()
                ...
                elif emaSlow < emaVSlow and emaFast < emaSlow and price > emaFast and price < emaVSlow and max < emaVSlow and emaFast < (emaVSlow - entryDist):
                    symbolGridParams()
